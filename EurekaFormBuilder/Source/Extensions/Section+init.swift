...
extension Section {
    public convenience init(header: String? = nil, footer: String? = nil, @EurekaRowBuilder child: () -> BaseRow) {
        self.init(header: header, footer: footer) { [child()] }
    }
    
    public convenience init(header: String? = nil, footer: String? = nil, @EurekaRowBuilder child: () -> Array<BaseRow>) {
        self.init()
